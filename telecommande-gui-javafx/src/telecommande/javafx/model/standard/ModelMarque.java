...
public class ModelMarque implements IModelMarque {
	...
	private final ObservableList<Marque> marques = FXCollections
	...
	public void preparerAjouter() {
		modeVue = CREER;
		mapper.update(new Marque(marques.get(marques.size()-1).getIdMarque()+1,""), marqueVue);
	}
	...
	private void trierListe() {
		FXCollections.sort(marques, (Comparator<Marque>) (c1, c2) -> {
